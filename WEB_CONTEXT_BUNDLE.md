...
```json
{
  ...
  "attempts": [
    {
      "artifacts": [],
      "attempt_id": "attempt:um-opg-46385-caccetta-h-ggkvist-conjecture-6289acb8-source-fidelity-01",
      "claims": [],
      "completed_at": null,
      "generator": "trusted-rolling-source-admission-v1",
      "inputs": [
        "problem-library/records/canonical-problems.jsonl",
        "https://www.unsolvedmath.com/problems/OPG-46385"
      ],
      "lifecycle": "planned",
      "method": "discovery",
      "objective": "Close the source-fidelity obligation before attempting the frozen root statement.",
      "obligation_graph_id": "graph:um-opg-46385-caccetta-h-ggkvist-conjecture-6289acb8-v1",
      "problem_contract_sha256": "9988c51c02a59f93a067513ae9592abcd355b1ef19c8dc19ee98a2925c07fa38",
      "problem_id": "problem:um-opg-46385-caccetta-h-ggkvist-conjecture-6289acb8",
      "route_id": "route:um-opg-46385-caccetta-h-ggkvist-conjecture-6289acb8-source-fidelity",
  ...
  "obligation_graphs": [
    {
      "attempt_id": "attempt:um-opg-46385-caccetta-h-ggkvist-conjecture-6289acb8-source-fidelity-01",
      "graph_id": "graph:um-opg-46385-caccetta-h-ggkvist-conjecture-6289acb8-v1",
      "obligations": [
        {
          "dependencies": [
            "obligation:um-opg-46385-caccetta-h-ggkvist-conjecture-6289acb8-statement-fidelity"
          ],
          "kind": "root_claim",
          "obligation_id": "obligation:um-opg-46385-caccetta-h-ggkvist-conjecture-6289acb8-root",
          "statement": {
            "formal_declaration": null,
            "language": "en",
            "text": "Conjecture Every simple digraph of order $n$ with minimum outdegree at least $r$ has a cycle with length at most $\\lceil n/r\\rceil$"
          },
          "statement_sha256": "766cfb9973e4967794a7cf04add392c3c241dc5886e2b10298e4141c024ac8a7"
        },
        {
          "dependencies": [],
          "kind": "definition",
          "obligation_id": "obligation:um-opg-46385-caccetta-h-ggkvist-conjecture-6289acb8-statement-fidelity",
          "statement": {
            "formal_declaration": null,
            "language": "en",
      ...
      "root_obligation_id": "obligation:um-opg-46385-caccetta-h-ggkvist-conjecture-6289acb8-root",
      "route_id": "route:um-opg-46385-caccetta-h-ggkvist-conjecture-6289acb8-source-fidelity"
    }
  ],
  "problem_contract": {
    ...
    "sources": [
      {
        ...
        "source_record_id": "unsolvedmath-opg-46385-60da5a896515",
        "url": "https://www.unsolvedmath.com/problems/OPG-46385"
      },
      {
        "retrieved_at": "2026-09-02T00:06:43Z",
